...
def test_installed_wheel_resolves_path_only_semantic_pins(
    ...
    for relative_path in (
        ...
        "permit_to_x/consequence_registry/v7.json",
        "permit_to_x/fact_profiles/v10.json",
        "permit_to_x/presentation_registry/v11.json",
        "permit_to_x/semantic_registry/v12.json",
        "permit_to_x/schemas/collections-exact-facts-v1.schema.json",
        "permit_to_x/test_vectors/consequence_registry/v8.json",
        "permit_to_x/consequence_registry/v8.json",
        "permit_to_x/fact_profiles/v11.json",
        "permit_to_x/presentation_registry/v12.json",
        "permit_to_x/semantic_registry/v13.json",
        "permit_to_x/schemas/insurance-claims-exact-facts-v1.schema.json",
        "permit_to_x/test_vectors/consequence_registry/v9.json",
        "permit_to_x/consequence_registry/v9.json",
        "permit_to_x/fact_profiles/v12.json",
        "permit_to_x/presentation_registry/v13.json",
        "permit_to_x/semantic_registry/v14.json",
        "permit_to_x/schemas/erp-crm-exact-facts-v1.schema.json",
        "permit_to_x/test_vectors/consequence_registry/v10.json",
        "permit_to_x/consequence_registry/v10.json",
        "permit_to_x/consequence_registry/v10.schema.json",
        "permit_to_x/fact_profiles/v13.json",
        "permit_to_x/fact_profiles/v13.schema.json",
        "permit_to_x/presentation_registry/v14.json",
        "permit_to_x/presentation_registry/v14.schema.json",
        "permit_to_x/semantic_registry/v15.json",
        ...
        "permit_to_x/consequence_registry/v12.json",
        "permit_to_x/consequence_registry/v12.schema.json",
        "permit_to_x/fact_profiles/v15.json",
        "permit_to_x/fact_profiles/v15.schema.json",
        "permit_to_x/presentation_registry/v16.json",
        "permit_to_x/presentation_registry/v16.schema.json",
        "permit_to_x/semantic_registry/v17.json",
        "permit_to_x/semantic_registry/v17.schema.json",
        "permit_to_x/schemas/wave5-breadth-exact-facts-v1.schema.json",
        "permit_to_x/test_vectors/consequence_registry/v13.json",
        "permit_to_x/consequence_registry/v13.json",
        "permit_to_x/consequence_registry/v13.schema.json",
        "permit_to_x/fact_profiles/v16.json",
        "permit_to_x/fact_profiles/v16.schema.json",
        "permit_to_x/presentation_registry/v17.json",
        "permit_to_x/presentation_registry/v17.schema.json",
        "permit_to_x/semantic_registry/v18.json",
        "permit_to_x/semantic_registry/v18.schema.json",
        ...
        "permit_to_x/presentation_registry/v22.json",
        "permit_to_x/presentation_registry/v22.schema.json",
