...
_SEMANTIC_REGISTRY_BY_VERSION = {
    ...
    "keel.semantic_selector_registry.v11": "semantic_registry/v11.json",
    "keel.semantic_selector_registry.v12": "semantic_registry/v12.json",
    ...
    "keel.semantic_selector_registry.v18": "semantic_registry/v18.json",
...
def _presentation_registry_for(
    ...
    for name in _PRESENTATION_REGISTRIES:
        ...
        if selector_version in {
            ...
            "keel.semantic_selector_registry.v18",
    ...
    legacy_name = (
        ...
        else "presentation_registry/v18.json"
        if selector_version == "keel.semantic_selector_registry.v19"
        else "presentation_registry/v17.json"
        if selector_version == "keel.semantic_selector_registry.v18"
        else "presentation_registry/v16.json"
        ...
        else "presentation_registry/v11.json"
        if selector_version == "keel.semantic_selector_registry.v13"
        else "presentation_registry/v10.json"
        if selector_version == "keel.semantic_selector_registry.v12"
        else "presentation_registry/v9.json"
        if selector_version == "keel.semantic_selector_registry.v11"
        else "presentation_registry/v8.json"
